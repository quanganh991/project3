                                                            ...
                                                            <form role="form" action="{{URL::to('/save-news')}}"
                                                                ...
                                                                <div class="card-body">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea type="text" name="multimedia"
                                                                               class="form-control" id="multimedia"
                                                                                  placeholder="Các đa phương tiện ngăn cách nhau bởi ký tự @"></textarea>
                                                                    </div>
                                                                    <div class="form-group">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{URL::to('/news-detail-'.$eachNews->id_news) }}">
                                            {{strlen($eachNews->context) > 50 ? substr($eachNews->context,0,45).'...' : $eachNews->context}}
                                        </a>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{URL::to('/unactive-news/'.$eachNews->id_news)}}">Ẩn</a>
                                        <?php
                                        }else{ //if ($eachNews->_status==0)
                                        ?>
                                        <p style="color: red">Đang bị ẩn</p>
                                        <a href="{{URL::to('/active-news/'.$eachNews->id_news)}}">Hiển thị</a>
                                        <?php
                                        }
                                        ?>
                                    </td>
                                    ...
                                    <td>
                                        {{strlen($eachNews->describ_multimedia) > 50 ? substr($eachNews->describ_multimedia,0,45).'...' : $eachNews->describ_multimedia}}
                                    </td>
                                    <td>
                                        <a href="{{URL::to('/edit-news/'.$eachNews->id_news)}}">Sửa</a>
                                    </td>
                                </tr>
                            @endforeach
