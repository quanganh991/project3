...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="{{ URL::to('/welcome-admin') }}" class="brand-link">
            <span style="text-align: center">Trang dành cho nhà báo</span>
        </a>
        ...
        <div class="sidebar">
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <?php
                    $nameJournalist = DB::table('users')
                        ->select('name_user')
                        ->where('id_user',Session::get('id_journalist'))
                        ->get()->first();
                    ?>
                    <a href="{{ URL::to('/change-admin-information') }}" class="d-block">{{$nameJournalist->name_user}}</a>
                </div>
            </div>
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{URL::to('/jnl-all-news')}}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{URL::to('/jnl-all-multiple-choice')}}" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Quản lý khảo sát người dùng/ câu hỏi</p>
                                </a>
                            </li>
                        </ul>
                    </li>
    ...
    <div class="content-wrapper">
        ...
        @yield('jnl_all_news')
        @yield('jnl_edit_news')
        @yield('jnl_information')
        @yield('jnl_all_multiple_choice')
    </div>
