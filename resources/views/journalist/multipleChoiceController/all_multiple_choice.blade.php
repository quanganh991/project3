...
@section('jnl_all_multiple_choice')
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="card-primary">
                                                            ...
                                                            <form role="form" action="{{URL::to('/jnl-save-multiple-choice')}}"
                                                                  method="post">
                                                                @csrf
                                                                {{ csrf_field() }}
                                                                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a style="color: darkorange"
                                           href="{{URL::to('/jnl-edit-news/'.$news->id_news) }}">
                                            {{$news->title}}
                                        </a>
                                    </td>
                                    <td>{{ $eachMultipleChoice->stt }}</td>
                                    <td>
                                        <a href="{{URL::to('/jnl-edit-multiple-choice/'.$eachMultipleChoice->id_multiple_choice) }}">
                                    ...
                                    <td><a href="{{URL::to('/news-detail-'.$eachMultipleChoice->id_news)}}">
                                            <img height="80px" width="80px"
                                                 src="<?php echo (explode("***<paragraph/>***", nl2br($eachMultipleChoice->img_explanation)))[0] ?>"
                                                 alt="">
                                        </a></td>
                                    <td>
                                        <a href="{{URL::to('/jnl-edit-multiple-choice/'.$eachMultipleChoice->id_multiple_choice)}}">Sửa</a>
                                    </td>
                                </tr>
                            @endforeach
