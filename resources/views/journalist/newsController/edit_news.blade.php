        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{URL::to('/jnl-submit-edit-news')}}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                $approver = DB::table('users')
                                    ->where('id_user',$edit_news->id_admin)
                                    ->get()->first();
                                ?>
                                <input hidden type="text" name="id_admin" class="form-control" id="id_admin" value="{{$approver != null ? $approver->id_user : ''}}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="multimedia" class="form-control" id="multimedia" value="{{$edit_news->multimedia}}">
                            </div>
