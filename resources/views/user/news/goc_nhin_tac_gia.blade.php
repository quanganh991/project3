        ...
        <div class="row">
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="slick_slider">
                        <div class="single_iteam"><a href="{{URL::to('/goc-nhin-tac-gia-'.$author->id_user)}}">
                                <img alt="" style="border-radius: 50%; width: 250px; height: 250px" src="{{$author->avatar}}"></a>
                            <div class="slider_article">
                                <h2><a class="slider_tittle"
                                       href="{{URL::to('/goc-nhin-tac-gia-'.$author->id_user)}}">{{$author->name_user}}</a>
                                </h2>
                                <p>{{$author->job}}</p>
                            </div>
                        </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <div class="latest_post">
                    <h2><span>Theo dòng sự kiện của {{$author->name_user}}</span></h2>
                            ...
                            @foreach($theoDongSuKien as $key => $eachOfTheoDongSuKien)
                                <li>
                                    <div class="media"><a href="{{URL::to('/detail-goc-nhin-'.$eachOfTheoDongSuKien->id_gocnhin)}}"
                                                          class="media-left"> <img alt="" style="border-radius: 50%" src="{{$author->avatar}}"></a>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="left_content">
                    <div class="single_post_content">
                        <h2><span>Bài viết mới nhất của {{$author->name_user}}</span></h2>
                        <ul class="business_catgnav  wow fadeInDown">
                            <li>
                                <figure class="bsbig_fig"><a href="{{URL::to('/detail-goc-nhin-'.$allGocNhin[0]->id_gocnhin)}}"
                                                             class="featured_img"> <img alt="" style="border-radius: 50%; height: 200px; width: 200px" src="{{$author->avatar}}">
            ...
            <div class="col-lg-4 col-md-4 col-sm-4">
                <aside class="right_content">
                    <div class="single_sidebar">
                        <h2><span>Được quan tâm nhiều của {{$author->name_user}}</span></h2>   <!--Nhiều lượt xem nhất đến ít lượt xem nhất-->
                        <ul class="spost_nav">
