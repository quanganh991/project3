...
@section('viewAllComment')
    <p style="color: red; font-size: 35px; font-weight: bold">Tất cả góc nhìn của bạn</p>
    <table id="example1" class="table table-bordered table-hover">
        ...
        <tbody>
        @foreach($controlUserGocNhin as $eachUserGocNhin)
            <tr>
...
{{--                    <a href="{{URL::to('/makeHot-gocnhin/'.$eachUserGocNhin->id_gocnhin)}}">Đánh dấu là hot</a>--}}
    ...
    <br>
    <p style="color: red; font-size: 35px; font-weight: bold">Góc nhìn đang chờ phê duyệt</p>
    <table id="example1" class="table table-bordered table-hover">
        <thead>
        <tr>
            <th>ID góc nhìn</th>
        ...
        <tbody>
        @foreach($pendingUserGocNhin as $eachGocNhinPending)
            <tr>
